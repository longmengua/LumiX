...
目前狀態：
- Funding settlement、snapshot、reconciliation、outbox relay、prediction market sync、bonus credit expiry、market-maker hedge execution、matching worker lease renewal 都有 scheduler baseline。
