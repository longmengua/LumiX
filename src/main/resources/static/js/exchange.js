...
const translations = {
    en: {
        ...
        'account.signInHelper': 'Sign in to view balances, frozen funds, and positions.',
        'account.createAccount': 'Create an account',
        'account.verificationHelper': 'Enter the verification code from your email to complete registration.',
        'account.assetsTitle': 'Assets',
        'account.assetsHelper': 'Balances update from your authenticated session.',
    ...
    'zh-TW': {
        ...
        'account.signInHelper': '登入後可查看餘額、凍結資金與倉位資訊。',
        'account.createAccount': '建立新帳號',
        'account.verificationHelper': '輸入信件中的驗證碼以完成註冊。',
        'account.assetsTitle': '資產',
        'account.assetsHelper': '資產會依登入 session 自動更新。',
        'book.title': '訂單簿',
    ...
    ms: {
        ...
        'account.signInHelper': 'Log masuk untuk melihat baki, dana dibekukan dan posisi.',
        'account.createAccount': 'Cipta akaun',
        'account.verificationHelper': 'Masukkan kod pengesahan daripada e-mel untuk melengkapkan pendaftaran.',
        'account.assetsTitle': 'Aset',
        'account.assetsHelper': 'Baki dikemas kini daripada sesi disahkan anda.',
    ...
    ko: {
        ...
        'account.signInHelper': '로그인하여 잔고, 동결 자금 및 포지션을 확인하세요.',
        'account.createAccount': '계정 만들기',
        'account.verificationHelper': '가입을 완료하려면 이메일의 인증 코드를 입력하세요.',
        'account.assetsTitle': '자산',
        'account.assetsHelper': '잔고는 인증된 세션에서 업데이트됩니다.',
        'book.title': '호가창',
