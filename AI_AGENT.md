...
Phase 21 market-data、Phase 22 deposit-observation、Phase 23 deposit-credit decision 與 Phase 24 withdrawal-request foundation 已完成，且不代表正式行情、入金、credit 或提款服務。逐卡 approve 機制依人類指示暫停；後續從 Phase 25 起依 task 依賴順序施工，直到人類明確說「開啟 approve」才恢復等待規則：

```text
1. Read AGENTS.md
2. Read AI_PROGRESS.md
3. Read docs/ai/AI_CONTEXT_ROUTING.md
4. Read the current phase README
5. Read the next task card and its dependencies
