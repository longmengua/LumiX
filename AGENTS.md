...
- Phase 11：已完成文件層級的 production architecture reset。
- Phase 12：下一個實作階段，主題是 Production Database Schema & Migration。
- Phase 13 到 Phase 36：已規劃但未開始。
- 不得跳 Phase。
...
## Current allowed implementation area
...
server/
  ...
  read-only schema documentation updates
...
- 資產數值應使用整數最小單位或可控 precision decimal。
...
P12-T05: Create order, trade, fill, reservation, and settlement schema
...
第一張任務卡請從 `docs/phases/PHASE_12_DATABASE_SCHEMA/tasks/P12-T01.md` 開始。
