...
- 第 18 階段：in progress — T01 completed，主題是 Futures Trading Sandbox。
- 第 19 階段 到 第 36 階段：已規劃但未開始。
- 不得跳階。
...
Root agent entry
  ...
  +-- docs/phases/PHASE_18_MATCHING_CONTRACT/README.md
  |
...
```text
Phase 18 futures sandbox task execution
Phase 17 completed review record
```

目前施工入口請從 `docs/phases/PHASE_18_MATCHING_CONTRACT/README.md` 開始；
Phase 17 的已批准歷史則保留在 `docs/phases/PHASE_17_ORDER_INTAKE/README.md` 與 `docs/phases/PHASE_17_ORDER_INTAKE/phase-17-final-review.md`。
