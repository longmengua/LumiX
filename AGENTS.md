...
Phase 18 is the next planned phase, but not started
```

目前 review / history 入口請從 `docs/phases/PHASE_17_ORDER_INTAKE/README.md` 與 `docs/phases/PHASE_17_ORDER_INTAKE/phase-17-final-review.md` 開始。
