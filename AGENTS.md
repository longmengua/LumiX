...
- 第 21 階段：已收到 planning kickoff，task cards 已草擬；runtime 尚未開工，等待人類審核與 P21-T01 明確實作批准。
- 第 22 階段 到 第 36 階段：已規劃但未開始。
- 不得跳階。
...
目前 Phase 21 已完成 task-card planning kickoff，runtime 尚未開工。P21-T01 尚未獲人類實作批准前，Codex / mini 只能進行狀態同步與唯讀檢查：

```text
Phase 21 market data pipeline task-card definition and review
```

後續 Phase 21 的施工入口為 `docs/phases/PHASE_21_MARKET_DATA/README.md`，提議第一張卡為 `p21-t01-inventory-boundary-invariants.md`；開始實作前必須先有經審核 task card 與人類明確批准。
