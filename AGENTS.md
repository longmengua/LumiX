...
- 第 21 階段：已正式開工；P21-T01 implementation review 已批准，P21-T02 已完成 immutable normalized event domain contract，等待 implementation review。Market Data pipeline runtime、外部 provider、公開 transport 尚未開始。
- P21-T03 到 P21-T08：仍等待逐卡人類實作批准，不得施工。
...
目前 Phase 21 已正式開工。P21-T01 implementation review 已批准；P21-T02 已完成 normalized market-data event domain contract，等待 implementation review。Market Data pipeline runtime 尚未開始；P21-T03 到 P21-T08 未獲人類逐卡實作批准前，Codex / mini 只能進行狀態同步與唯讀檢查：

```text
Phase 21 market data pipeline task-card definition and review
```

後續 Phase 21 的施工入口為 `docs/phases/PHASE_21_MARKET_DATA/README.md`。P21-T01 的盤點與不變式結論位於 `p21-t01-implementation-review.md`，P21-T02 的實作證據位於 `p21-t02-implementation-review.md`；P21-T03 仍須另行取得人類明確批准。
