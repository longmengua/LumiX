...
- 第 17 階段：implementation completed / pending human review，主題是 Futures Core Model。
...
```text
Phase 17 final review and human-review handoff
```

目前 review 入口請從 `docs/phases/PHASE_17_ORDER_INTAKE/README.md` 與 `docs/phases/PHASE_17_ORDER_INTAKE/phase-17-final-review.md` 開始。
