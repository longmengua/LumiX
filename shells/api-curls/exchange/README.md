...
- Recovery：包含 snapshot recovery、全帳戶 reconciliation、daily/category finance report、category export batch、ledger archive manifest restore smoke、replay validation、outbox/domain-state consistency 範例。
