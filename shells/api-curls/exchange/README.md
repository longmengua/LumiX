...
- 資金/風控：入金、出金、margin transfer、transfer list、bonus-credit report/clawback、turnover summary/records、risk snapshot、persisted risk snapshot、price oracle、ADL queue claim/release/execution 範例已補齊。
