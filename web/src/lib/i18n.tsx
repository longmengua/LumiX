...
const zhDictionary = {
  ...
  'market.lastPrice': '最新成交價',
  'market.change24h': '24h 漲跌',
  'market.high24h': '24h 最高',
  'market.low24h': '24h 最低',
  'market.volume': '24h 合約成交量 ({symbol})',
  'perp.title': '合約風險資訊',
  'perp.markPrice': '標記價格',
  'perp.indexPrice': '指數價格',
  'perp.fundingRate': '資金費率',
  'perp.nextFunding': '下次資金費',
  'perp.leverage': '槓桿',
  'perp.marginMode': '保證金模式',
  'perp.contractSize': '合約面值',
  'perp.liquidation': '預估強平價',
  'kline.title': '永續合約 K 線 (1m)',
  'kline.liveUpdates': '即時更新',
  'kline.empty': '尚未載入 K 線',
  'kline.chartAria': 'K 線圖',
  'kline.tool.crosshair': '十字',
  'kline.tool.hline': '畫線',
  'kline.tool.clear': '清除',
  'history.title': '合約成交紀錄',
  'history.heading.time': '時間',
  'history.heading.side': '方向',
  'history.heading.price': '價格',
  'history.heading.qty': '張數',
  'history.heading.notional': '名目',
  'history.empty': '尚未收到成交資料',
  'history.loading': '載入中...',
  'history.end': '已載入全部成交紀錄',
  'positions.title': '合約持倉',
  'positions.heading.market': '合約',
  'positions.heading.side': '方向',
  'positions.heading.qty': '張數',
  'positions.heading.entry': '建倉價',
  'positions.heading.margin': '保證金',
  'positions.heading.pnl': '未實現盈虧',
  'tabs.tradingActivity': '交易活動',
  'order.title': '永續合約下單',
  'order.label.side': '方向',
  'order.label.type': '類型',
  'order.label.price': '價格',
  'order.label.qty': '張數',
  'order.submitBuy': '開多 / 買入',
  'order.submitSell': '開空 / 賣出',
  'order.current': '目前合約委託: {side} | {type} | 價格 {price} | 張數 {qty}',
  'message.title': '訊息中心',
  'message.empty': '尚無訊息'
} satisfies Record<string, string>;

const enDictionary = {
  'app.title': 'LumiX Perpetual Futures',
  'app.symbolLabel': 'Contract',
  ...
  'market.lastPrice': 'Last Traded Price',
  'market.change24h': '24h Change',
  'market.high24h': '24h High',
  'market.low24h': '24h Low',
  'market.volume': '24h Contract Volume ({symbol})',
  'perp.title': 'Contract Risk',
  'perp.markPrice': 'Mark Price',
  'perp.indexPrice': 'Index Price',
  'perp.fundingRate': 'Funding Rate',
  'perp.nextFunding': 'Next Funding',
  'perp.leverage': 'Leverage',
  'perp.marginMode': 'Margin Mode',
  'perp.contractSize': 'Contract Size',
  'perp.liquidation': 'Est. Liquidation',
  'kline.title': 'Perpetual K Line (1m)',
  'kline.liveUpdates': 'Live updates',
  'kline.empty': 'No K-line loaded yet',
  'kline.chartAria': 'K-line chart',
  'kline.tool.crosshair': 'Cross',
  'kline.tool.hline': 'Line',
  'kline.tool.clear': 'Clear',
  'history.title': 'Contract Trade History',
  'history.heading.time': 'Time',
  'history.heading.side': 'Side',
  'history.heading.price': 'Price',
  'history.heading.qty': 'Contracts',
  'history.heading.notional': 'Notional',
  'history.empty': 'No trade data yet',
  'history.loading': 'Loading...',
  'history.end': 'Loaded all trades',
  'positions.title': 'Perpetual Positions',
  'positions.heading.market': 'Contract',
  'positions.heading.side': 'Side',
  'positions.heading.qty': 'Contracts',
  'positions.heading.entry': 'Entry',
  'positions.heading.margin': 'Margin',
  'positions.heading.pnl': 'PnL',
  'tabs.tradingActivity': 'Trading Activity',
  'order.title': 'Perpetual Order Entry',
  'order.label.side': 'Side',
  'order.label.type': 'Type',
  'order.label.price': 'Price',
  'order.label.qty': 'Contracts',
  'order.submitBuy': 'Open Long / Buy',
  'order.submitSell': 'Open Short / Sell',
  'order.current': 'Current contract order: {side} | {type} | price {price} | contracts {qty}',
