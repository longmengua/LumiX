...
import { AssetReconciliationPanel } from './AssetAdjustmentAuditPanel';
...
export function AssetAnalysisPanel() {
  ...
  return <section className="admin-asset-analysis" aria-label={t('admin.assetsAnalysisTitle')}>
    ...
    {tab === 'reconciliation' ? <AssetReconciliationPanel /> : <EmptyState title={t(`admin.assetsAnalysisEmptyTitle.${tab}`)} description={t(`admin.assetsAnalysisEmptyDescription.${tab}`)} />}
  </section>;
}
