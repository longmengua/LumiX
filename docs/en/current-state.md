...
| --- | ---: | ---: | --- |
| P0 Required | 33 | 10 | Core MVP capability exists, but many production blockers remain. |
...
| Total | 41 | 29 | The project has a baseline, but production hardening is still the main body of work. |
