...
- Operations metrics now expose in-process matching latency, rejection rate, fill rate, DB operation latency, and Redis operation latency counters; Kafka lag collection and production metrics export are still incomplete.
