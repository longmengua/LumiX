...
- The ledger now has a durable double-entry journal, bonus-credit account separation, bonus expiry scanner baseline, bonus report/clawback APIs, turnover facts, and replay path; audit retention, deeper replay validation, bonus eligibility rules, broader campaign reporting, turnover reconciliation, and operational controls are still incomplete.
