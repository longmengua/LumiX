...
| --- | ---: | ---: | --- |
| P0 Required | 41 | 2 | Core MVP capability exists, but many production blockers remain. |
...
| Total | 49 | 21 | The project has a baseline, but production hardening is still the main body of work. |
