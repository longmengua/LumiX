...
- Polymarket CLOB place now has a `clientRequestId` local idempotency baseline; broader order lifecycle, schema versioning, cancel/sync/reconcile idempotency, and the user WebSocket worker are mostly still TODO.
