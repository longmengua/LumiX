...
| --- | ---: | ---: | --- |
| P0 Required | 40 | 3 | Core MVP capability exists, but many production blockers remain. |
...
| Total | 48 | 22 | The project has a baseline, but production hardening is still the main body of work. |
