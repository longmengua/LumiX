...
| P1 Strongly Recommended | 17 | 5 | Operations, market data, Polymarket, and observability still need hardening. |
...
2. Finish the remaining P1 blockers: independently deployed WebSocket/SSE gateway, independently deployed Polymarket user WebSocket worker, production metrics export, tracing exporter/dashboard wiring, and alert backend integration.
