...
| --- | ---: | ---: | --- |
| P0 Required | 34 | 9 | Core MVP capability exists, but many production blockers remain. |
...
| Total | 42 | 28 | The project has a baseline, but production hardening is still the main body of work. |
