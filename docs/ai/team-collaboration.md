...
- Work from one Markdown task entry point whenever possible: a file under `docs/tasks/`, `docs/roadmap/todo.md`, or a specific `docs/ai/maps/*.md` file.
...
- Avoid parallel edits to these high-conflict files unless the task is explicitly about them: `AGENTS.md`, `docs/roadmap/todo.md`, `docs/status/current-state.md`, `docs/ai/code-map.md`, Flyway migrations, and global config files.
