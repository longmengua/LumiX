...
```text
Read AGENTS.md, AI_AGENT.md, AI_PROGRESS.md, docs/ai/AI_CONTEXT_ROUTING.md, and docs/phases/PHASE_17_ORDER_INTAKE/README.md.

Implement only the first incomplete P17 task listed in docs/phases/PHASE_17_ORDER_INTAKE/README.md.
