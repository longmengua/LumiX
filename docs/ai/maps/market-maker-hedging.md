...
- Admin UI: `src/main/resources/static/exchange-market-maker-admin.html` lets operators create/update market-maker profiles, edit one per-symbol strategy/risk-limit row, inspect active quotes/fills/reconciliation/idempotency status, and trigger guarded manual hedge execution.
