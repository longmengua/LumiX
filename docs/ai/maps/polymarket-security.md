...
- `docs/integrations/polymarket-order-transition-matrix.md` and `docs/integrations/polymarket-order-transition-matrix.md` define the local/CLOB/trade/settlement transition contract, including terminal downgrade guards, trade event replay behavior, settlement terminal rules, and remaining implementation TODOs.
...
- Target custodial routing design: `docs/integrations/custodial-polymarket-routing-security.md` / `docs/integrations/custodial-polymarket-routing-security.md`
- Implementation task lineage: `docs/tasks/2026-06-16-0528-unfinished-tasks.md` lists the removed `docs/tasks/post-v1/06-custodial-polymarket-routing.md` task.
...
- External API idempotency inventory: `docs/integrations/external-api-idempotency.md`
