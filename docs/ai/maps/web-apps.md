...
- Current static admin market-maker page: `src/main/resources/static/exchange-market-maker-admin.html`
...
- `exchange.html`, `admin-console.html`, and `exchange-market-maker-admin.html` share the `localStorage.exchangeLanguage` locale preference for English, Traditional Chinese, Bahasa Malaysia, and Korean; English remains the default for first-load demos and browser tests.
