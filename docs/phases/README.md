...
PHASE_21_MARKET_DATA/          COMPLETED_FOR_MARKET_DATA_FOUNDATION (immutable domain、admission-policy、唯讀 projection/aggregation、replay/resync、internal query/backpressure foundation；NOT pipeline runtime、external provider 或 public transport)
