...
PHASE_18_MATCHING_CONTRACT/    in progress — T01 completed (Phase 18 - Futures Trading Sandbox; futures order placement only; NOT matching/fill/position update/PnL/funding/settlement ready; NOT public futures trading ready; NOT real-money ready)
