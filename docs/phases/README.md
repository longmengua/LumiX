...
PHASE_21_MARKET_DATA/          FORMALLY_STARTED_P21_T01_T04_IMPLEMENTATION_REVIEW_APPROVED_P21_T05_COMPLETED_AWAITING_IMPLEMENTATION_REVIEW (P21-T02/T03/T04/T05 僅完成 immutable domain、admission-policy 與唯讀 projection/aggregation foundation；pipeline runtime、外部 provider 與公開 transport 未開始；P21-T06 至 P21-T08 仍等待逐卡人類批准)
...
```text
Phase 21 P21-T05 implementation review — P21-T01 到 P21-T04 implementation review 已批准，P21-T05 已完成 immutable trade/ticker/candle aggregation 並等待 implementation review；P21-T06 至 P21-T08 與 Phase 22–36 的所有 runtime 工作仍等待逐卡人類批准
```
