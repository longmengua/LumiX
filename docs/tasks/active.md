...
| --- | --- | --- | --- | --- | --- |
| done | docs/tasks/production-readiness/02-p1-production-hardening.md#observability-alert-rules | T2 observability-alert-rules | 2026-06-03 | `docs/en/alert-rules.md`, `docs/zh-TW/alert-rules.md`, `docs/en/observability.md`, `docs/zh-TW/observability.md`, `docs/en/todo.md`, `docs/zh-TW/todo.md`, `docs/en/current-state.md`, `docs/zh-TW/current-state.md`, `docs/tasks/production-readiness/02-p1-production-hardening.md` |  |
| done | docs/tasks/production-readiness/02-p1-production-hardening.md#observability-tracing-export | T2 observability-tracing-export | 2026-06-03 | `src/main/java/com/example/exchange/infra/config/*Tracing*`, `src/main/resources/application*.yml`, `docs/en/observability.md`, `docs/zh-TW/observability.md`, `src/main/java/com/example/exchange/infra/tracing/README.md`, `docs/tasks/production-readiness/02-p1-production-hardening.md` |  |
| done | docs/tasks/production-readiness/02-p1-production-hardening.md#observability-kafka-lag | T2 observability-kafka-lag | 2026-06-03 | `src/main/java/com/example/exchange/application/service/OperationalMetricsService.java`, `src/main/java/com/example/exchange/domain/model/dto/OperationalMetricsSnapshot.java`, `src/test/java/com/example/exchange/application/service/OperationalMetricsServiceTest.java`, `docs/en/observability.md`, `docs/zh-TW/observability.md`, `docs/tasks/production-readiness/02-p1-production-hardening.md` |  |
| done | docs/tasks/production-readiness/02-p1-production-hardening.md#observability-db-redis-latency | T2 observability-db-redis-latency | 2026-06-03 | `src/main/java/com/example/exchange/application/service/OperationalMetricsService.java`, `src/main/java/com/example/exchange/domain/model/dto/OperationalMetricsSnapshot.java`, `src/test/java/com/example/exchange/application/service/OperationalMetricsServiceTest.java`, `docs/en/observability.md`, `docs/zh-TW/observability.md`, `docs/tasks/production-readiness/02-p1-production-hardening.md` |  |
...
| done | docs/tasks/p2/01-admin-market-config-screen.md | T3 admin-market-config | 2026-06-03 | `docs/tasks/p2/01-admin-market-config-screen.md`, `docs/tasks/web/02-admin-web.md`, `docs/ai/maps/web-apps.md`, `docs/en/todo.md`, `docs/zh-TW/todo.md`, `docs/en/current-state.md`, `docs/zh-TW/current-state.md`, admin frontend files if present |  |
| done | docs/tasks/p2/02-admin-risk-parameter-screen.md | T3 admin-risk-params | 2026-06-03 | `docs/tasks/p2/02-admin-risk-parameter-screen.md`, `docs/tasks/web/02-admin-web.md`, `docs/ai/maps/web-apps.md`, `docs/ai/maps/risk-ledger-funds.md`, `docs/en/todo.md`, `docs/zh-TW/todo.md`, `docs/en/current-state.md`, `docs/zh-TW/current-state.md`, admin risk frontend/API files if present |  |
| doing | docs/tasks/p2/03-admin-dlq-replay-screen.md | Codex admin-dlq-replay | 2026-06-10 | `src/main/java/com/example/exchange/interfaces/web/controller`, `src/main/java/com/example/exchange/interfaces/web/dto`, `src/main/resources/static`, `src/test/java/com/example/exchange/interfaces/web/controller`, `docs/en/todo.md`, `docs/zh-TW/todo.md`, `docs/ai/maps/web-apps.md`, `docs/ai/maps/reliability-market-data.md`, `shells/api-curls/exchange` |  |
