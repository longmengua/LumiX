...
| doing | docs/tasks/p2/01-admin-market-config-screen.md | T3 admin-market-config | 2026-06-03 | `docs/tasks/p2/01-admin-market-config-screen.md`, `docs/tasks/web/02-admin-web.md`, `docs/ai/maps/web-apps.md`, `docs/en/todo.md`, `docs/zh-TW/todo.md`, `docs/en/current-state.md`, `docs/zh-TW/current-state.md`, admin frontend files if present |  |
