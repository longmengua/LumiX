...
| doing | docs/tasks/p2/02-admin-risk-parameter-screen.md | T3 admin-risk-params | 2026-06-03 | `docs/tasks/p2/02-admin-risk-parameter-screen.md`, `docs/tasks/web/02-admin-web.md`, `docs/ai/maps/web-apps.md`, `docs/ai/maps/risk-ledger-funds.md`, `docs/en/todo.md`, `docs/zh-TW/todo.md`, `docs/en/current-state.md`, `docs/zh-TW/current-state.md`, admin risk frontend/API files if present |  |
