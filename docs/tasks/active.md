...
| --- | --- | --- | --- | --- | --- |
| doing | docs/tasks/production-readiness/02-p1-production-hardening.md#polymarket-trade-lifecycle-projection | T2 polymarket-trade-projection | 2026-06-03 | `src/main/java/com/example/exchange/domain/service/Polymarket*`, `src/main/java/com/example/exchange/application/service/OrderLifecycleProjectionService.java`, `src/test/java/com/example/exchange/domain/service/Polymarket*`, `docs/ai/maps/polymarket-security.md`, `docs/tasks/production-readiness/02-p1-production-hardening.md` |  |
