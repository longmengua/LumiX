# Post-v1 Production Hardening Tasks

This task group is the next implementation lane after the bounded core-v1 freeze. It keeps production hardening work separate from web, Polymarket expansion, reporting, compliance, and broad observability tracks.

## Task Order

1. [01-transaction-boundaries.md](01-transaction-boundaries.md)
2. [02-production-worker-routing.md](02-production-worker-routing.md)
